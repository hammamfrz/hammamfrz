...
# Hi there, I'm Hammam Fariz Raharjo 👋

Performance-driven **Backend Developer** with over 3 years of experience specializing in building scalable systems and RESTful APIs using **NestJS** and **Express.js**. [cite_start]I have a proven track record in migrating legacy systems to microservices and implementing real-time monitoring solutions.
...
### 🔭 Current Focus
- 🚀 Working as a **Backend Developer** at **PT Transnovasi Bangun Persada**, focusing on real-time tracking for national-scale monitoring.
- 🛠️ Optimizing workflows with **Bun** runtime and **monorepo** architectures.

### 🛠️ Tech Stack
- **Languages**: TypeScript, JavaScript, Golang, Python, C++, Java.
- **Backend**: NestJS, Node.js, Express, Microservices (CQRS & DDD).
- **Databases**: PostgreSQL, MongoDB, Redis, MySQL, Prisma ORM.
- **Infrastructure**: Docker, Google Cloud Platform (GCP), CI/CD.
